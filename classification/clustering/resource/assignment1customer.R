...
setwd("C:/Users/kanna/Documents/ML Assignments/Assignment1_final/Assignment1_final/resource")
library(ggplot2)
library(GGally)
library(DMwR)
library(plotly)
...
write(withinSSrange(prod.scale,1,50,150))
...
ggplot(data=clusteredProd,aes(x=visit,y= totrev,color= cluster))+
